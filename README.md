...
## 🛠️ Backend: Herramientas y Librerías
...
> **Nota:** Una vez clonado el repositorio, asegúrate de ejecutar `npm install` en la terminal para descargar todas las librerías necesarias.
...
| **nodemon** | `^3.1.14` | *(DevDependency)* Herramienta que reinicia automáticamente el servidor al detectar cambios en el código. |
